...
# are added to the $(BAIKALOS_FONTS_FILE).
include $(CLEAR_VARS)
...
BAIKALOS_FONTS_FILE := vendor/baikalos/prebuilt/common/etc/fonts_customization.xml

ifdef ADDITIONAL_FONTS_FILE
ADDITIONAL_FONTS_SCRIPT := vendor/baikalos/build/tools/add_additional_fonts.py
...
$(ADD_ADDITIONAL_FONTS): $(ADDITIONAL_FONTS_SCRIPT) $(BAIKALOS_FONTS_FILE) $(ADDITIONAL_FONTS_FILE)
	rm -f $@
	python3 $(PRIVATE_SCRIPT) $@ $(PRIVATE_ADDITIONAL_FONTS_FILE)
else
ADD_ADDITIONAL_FONTS := $(BAIKALOS_FONTS_FILE)
endif
